...
namespace River.Skills
{
    class Slash : DamageEmitter
    {
            ...
            Texture, SkillType, Debuff)
        {
            ...
            SetEffect(ref MainEffect, 16, Color.White, 24, new VariableFloat { Value = 16f, Variation = 4f }, 0.05f, 100f);

            ////////////
            //SECONDARY:
            ////////////

            SetEffect(ref SecondaryEffect, 2f, Color.Gray, 24, new VariableFloat { Value = 4f, Variation = 4f }, 0.5f, 300f);
