...
namespace River
{
    ...
    class DamageEmitter
    {
        ...
        public CircleEmitter MainEffect = null;
        public CircleEmitter SecondaryEffect = null;
        ...
        protected static void CreateSideShots(Level LevelPTR, Entity ParentEntity, DamageEmitter DamageEmitter, float AngleOffset)
        {
            ...
            for (int Side = 1; Side <= 2; Side++)
            {
                ...
                //Copy effects
                LevelPTR.DamageEmitters[LevelPTR.DamageEmitters.Count - 1].MainEffect = (CircleEmitter)DamageEmitter.MainEffect.DeepCopy();
                LevelPTR.DamageEmitters[LevelPTR.DamageEmitters.Count - 1].SecondaryEffect = (CircleEmitter)DamageEmitter.SecondaryEffect.DeepCopy();
